<template>
  ...
  <v-container fluid v-show="!answer_hidden">
    ...
    <v-radio-group v-model="Selected_3" inline color="green darken-5">
      <v-radio label="ガッツリ食べたい" value="ガッツリとした"></v-radio>
      <v-radio label="さっぱり系がいい" value="さっぱりとした"></v-radio>
      <v-radio label="おしゃれな料理を楽しみたい" value="おしゃれな"></v-radio>
    ...
    <div v-show="chk_location">
      ...
      <v-text-field
        ...
        clearable
      ></v-text-field>
      <v-checkbox label="店も知りたい" v-model="chk_restaurant" inline color="green darken-5"/>
    </div>
...
<script lang='ts' setup>
  ...
  const join = () => {
    ...
    set_question.value = set_Selected_5.value + Selected_4.value + Selected_1.value + Selected_3.value + Selected_2.value + 'を楽しむのにおすすめの' + restaurant.value + 'を教えてください。';
  }
